...
```bash
git clone https://github.com/raushanraj77/playwright-ts.git
```
...
5. (Optional) Git User setup for the first time. If you are a code/test contributor, set up your user in GIT using the commands:
   ...
   git remote set-url origin https://USERNAME:SECRETTOKEN@github.com/raushanraj77/playwright-ts.git
   ```
