...
import { ACTION_TIMEOUT, EXPECT_TIMEOUT, NAVIGATION_TIMEOUT, TEST_TIMEOUT } from './src/raushan-playwright/utils/timeout-constants';
...
export default defineConfig({
   ...
   */
  //reporter: [['./src/raushan-playwright/setup/custom-logger.ts'], ['html', { open: 'never' }], ['dot']],
...
// ],
   ...
   */
  globalSetup: require.resolve('./src/raushan-playwright/setup/global-setup.ts'),
  globalTeardown: require.resolve('./src/raushan-playwright/setup/global-teardown.ts'),
